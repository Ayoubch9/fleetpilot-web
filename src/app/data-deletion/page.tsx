...
export const metadata = {
  title: "Data Deletion",
  description:
    "How to permanently delete a FleetPilot account and what happens afterward.",
};
...
export default function DataDeletionPage() {
  return (
    <LegalPage
      ...
      title="FleetPilot Data Deletion"
      intro="FleetPilot provides a self-service path to permanently delete your account from the web application."
    >
      <LegalSection title="Delete your account">
        <ol>
          <li>Sign in to FleetPilot.</li>
          <li>Open Settings.</li>
      ...
      <LegalSection title="Company owners">
        <p>
          ...
          also remove the FleetPilot company workspace and eligible
          company-scoped operational records.
        </p>
        <p>
          If other company members remain, FleetPilot blocks owner deletion
      ...
      <LegalSection title="What is retained after deletion">
        <p>
          FleetPilot retains a minimal deletion marker containing the
      ...
      <LegalSection title="Signing in with Google after deletion">
        <p>
          If the same Google email signs in again, FleetPilot recognizes that
          the former account was deleted and shows a deleted-account screen.
          The old business records are not restored.
        </p>
        <p>
          The user can explicitly choose to create a new blank FleetPilot
      ...
      <LegalSection title="Need to start over?">
        <p>
          ...
          Otherwise, return to <Link href="/login">FleetPilot sign in</Link>.
        </p>
      </LegalSection>
    </LegalPage>
  );
