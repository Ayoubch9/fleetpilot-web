...
export const metadata = {
  ...
  description: "FleetPilot web application terms of service.",
};
...
export default function TermsPage() {
  return (
    <LegalPage
      eyebrow="LEGAL"
      title="Terms of Service"
      intro="These Terms govern use of the FleetPilot web application, including free trials, account features, trucking-business tools, and Google sign-in."
    >
      <LegalSection title="1. Using FleetPilot">
        <p>
          You may use FleetPilot only for lawful purposes and only if you are
      ...
      <LegalSection title="2. Accounts and company workspaces">
        <p>
          FleetPilot accounts can be created with supported email credentials
        ...
        <p>
          ...
          security controls, interfere with the service, or use FleetPilot for
      ...
      <LegalSection title="3. Operational calculations">
        <p>
          FleetPilot provides calculations and summaries based on data entered
      ...
      <LegalSection title="4. Your data">
        <p>
          ...
          grant FleetPilot the limited permission needed to host, process,
      ...
      <LegalSection title="5. Free trial and paid features">
        <p>
          FleetPilot may offer a time-limited free trial. Paid billing,
      ...
      <LegalSection title="6. Third-party services">
        <p>
          FleetPilot depends on third-party infrastructure and authentication
          providers such as Supabase, Vercel, and Google. Availability of those
          services can affect FleetPilot, and their separate terms may apply to
      ...
      <LegalSection title="7. Availability and changes">
        <p>
          FleetPilot may add, modify, suspend, or discontinue product features.
      ...
      <LegalSection title="8. Account termination and deletion">
        <p>
          ...
          data is deleted with the account. If other members remain, FleetPilot
          may require ownership/member access to be resolved before deletion.
        </p>
        <p>
          FleetPilot may restrict or terminate access when reasonably necessary
      ...
      <LegalSection title="9. Disclaimers">
        <p>
          FleetPilot is provided on an as-available basis. To the extent
          permitted by applicable law, FleetPilot does not guarantee that every
      ...
      <LegalSection title="10. Limitation of responsibility">
        <p>
          To the extent permitted by applicable law, FleetPilot is not
      ...
      <LegalSection title="11. Changes to these Terms">
        <p>
          These Terms may be updated as FleetPilot develops. Continued use
