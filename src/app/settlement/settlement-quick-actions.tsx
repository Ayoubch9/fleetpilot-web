...
export default function SettlementQuickActions({
  ...
  function exportPdf() {
    ...
    try {
      const lines: string[] = [
        "MILEVOXA WEEKLY SETTLEMENT",
        summary.companyName || "MileVoxa Company",
      ...
      anchor.href = url;
      anchor.download = `milevoxa-settlement-${summary.weekStart}.pdf`;
              ...
              <div className="fp-settle-issues-body">
                {weekIssues.length === 0 ? (
                  <div className="fp-settle-no-issues">
                    ...
                    <p>
                      MileVoxa did not find any obvious settlement problems
...
function buildSimplePdf(sourceLines: string[]) {
  ...
  if (!pages.length) pages.push(["MileVoxa Weekly Settlement"]);
